...
# Defini un formualire pour la recherche
# d'installations selon un arrondissement
...
# Defini un formualire pour la recherche d'informations
# sur une installation selon son nom
